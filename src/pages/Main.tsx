  ...
  return (
    <div className="flex flex-wrap justify-center h-[100vh] bg-[#efeef2]">
      <div className="w-2/5 flex flex-wrap items-center justify-center">
        <Link to="/memorey" className="w-full text-4xl font-bold text-center h-1/6 hover:bg-blue-400 transition-all flex flex-wrap items-center justify-center cursor-pointer hover:cursor-pointer"><span className="hover:cursor-pointer cursor-pointer">Memory Game</span></Link>
        ...
        <Link to="/blackjax" className="w-full text-4xl font-bold text-center h-1/6 hover:bg-[#dd7074] transition-all flex flex-wrap items-center justify-center cursor-pointer hover:cursor-pointer"><span className="hover:cursor-pointer cursor-pointer">Blackjax</span></Link>
